...
class Player(BasePlayer):
    ...
    unemployment = models.IntegerField(
        label="The unemployment rate in UK:",
        choices=[
...
class InflationsErwartung(Page):
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        if player.max_expectation - player.min_expectation > 1:
            player.stop1 = False
...
class Q25Screen(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        return (player.treatment == 1 or player.treatment == 3) and player.stop1 == True and player.stop2 == False and player.range_q25 > 1
...
class Q75Screen(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        return (player.treatment == 1 or player.treatment == 3) and player.stop1 == True and player.stop2 == True and player.stop3 == False and player.range_q75 > 1
...
class Bisection1(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        return (player.treatment == 1 or player.treatment == 3) and player.in_round(1).range > 1 and player.round_number >= 1 and (player.stop1 == False or player.in_round(player.round_number - 1).stop1 == False)
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        if player.treatment == 1:
            if player.counting < 3 and player.range > 1.0:
                player.stop1 = False
            else:
                player.stop1 = True
                player.stop2 = False
...
class Q25_1(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        return (player.treatment == 1 or player.treatment == 3) and player.round_number > 1 and player.in_round(player.round_number - 1).stop1 == True and player.in_round(player.round_number - 1).stop2 == False and player.in_round(player.round_number - 1).range_q25 > 1
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        if player.treatment == 1:
            if player.counting < 3 and player.range_q25 > 1:
                player.stop2 = False
            else:
                player.stop3 = False
...
class Q75_1(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        return (player.treatment == 1 or player.treatment == 3) and player.round_number > 1 and player.in_round(player.round_number - 1).stop1 == True and player.in_round(player.round_number - 1).stop2 == True and player.in_round(player.round_number - 1).stop3 == False and player.in_round(player.round_number - 1).range_q75 > 1
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        player.range_q75 = player.max_expectation_q75 - player.min_expectation_q75
        if player.treatment == 1:
            if player.counting < 3 and player.range_q75 > 1:
                player.stop3 = False
            else:
